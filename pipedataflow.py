...
def pipeline():
  # Command line arguments
    ...
    parser.add_argument('--sdk_location', required=True, help='Specify image URI')
    ...
    options.view_as(GoogleCloudOptions).job_name = '{0}{1}'.format('pipeg',opts.file.replace(".",""))
    options.view_as(StandardOptions).runner = opts.runner
    options.view_as(GoogleCloudOptions).sdk_location = opts.sdk_location
